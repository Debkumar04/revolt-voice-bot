...
const chatSession = model.startChat({
  ...
  history: [
    ...
    {
      role: "model",
      parts: [{ text: "I'm Rev, your Revolt Motors assistant. How can I help you with our electric vehicles today?" }],
    }
  ]
});
...
export const streamVoiceResponse = async (promptText) => {
  try {
    ...
    return filteredResponse || "Please visit revoltmotors.com for more information.";
  } catch (error) {
    console.error("Error:", error);
    throw new Error("I'm having trouble connecting to Revolt information. Please try again later.");
  }
};